...
// IF STATEMENT TO VERIFY IF INPUT HAS BEEN ADDED TO THE FORM
if ($_SERVER ["REQUEST_METHOD"] == "POST") {
    ...
    // VALIDATION: NAME CAN ONLY CONTAIN LETTERS AND WHITE SPACE
      ...
      echo "<span class=\"error\">Error: Website is Required</span>";
       ...
       echo"<span class=\"error\">Error: Name only can contain letters</span>";
      ...
      echo "<span class=\"error\">Error: Website is in the wrong format</span>";
...
/* FUNCTION TO VALIDATE THE DATA AND ADD SECURITY TO FORM */
function val($data) {
  $data = trim($data);
